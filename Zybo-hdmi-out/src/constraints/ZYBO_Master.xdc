...
set_property PACKAGE_PIN V15 [get_ports {paint_btn_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {paint_btn_tri_i[0]}]

set_property PACKAGE_PIN V15 [get_ports {paint_tri_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {paint_tri_i[0]}]
